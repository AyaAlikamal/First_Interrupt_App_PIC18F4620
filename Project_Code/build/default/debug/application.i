...
Std_ReturnType Interrupt_RBx_Initialization(const Ex_Interrupt_INTx_t *int_obj);
Std_ReturnType Interrupt_RBx_DeInitialization(const Ex_Interrupt_INTx_t *int_obj);
# 12 "./application.h" 2
...
Ex_Interrupt_INTx_t INT1_obj= {
 ...
 .edge = EX_Interrupt_Falling_Edge,
 .priority = Interrupt_Periority_HIGH,
